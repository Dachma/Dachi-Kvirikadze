    ...
    return (
      <div className="product" key={this.props.src} onClick={(e) => e.target.className === "product-main-image" ? productClick() : null}>
        ...
        <div>
          ...
          <img className="product-main-image" style={!clickedProduct[0].inStock ? {"height": "306px"} : null} src={this.props.src}/>
          <div className="product-cart">
            <img className="product-cart-image" onClick={() => sendToCart()} src={emptyCart} />
